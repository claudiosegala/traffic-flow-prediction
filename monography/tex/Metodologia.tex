...
Este trabalho tem como foco dois cruzamentos de Brasília. Tais cruzamentos estão localizados na Avenida Hélio Prates, em Taguatinga. Os dados coletados pelos fiscalizadores presentes nesses cruzamentos são referentes aos meses de Junho, Julho e Agosto de 2016. Dessa forma, os resultados apresentados aqui nesta monografia podem ser distintos se os modelos forem utilizados em meses diferentes dos propostos no trabalho.
