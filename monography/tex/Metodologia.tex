...
Visto que a predição do fluxo é o foco do trabalho, que tem-se um conjunto de pares entrada e saída e que o fluxo é quantitativo, serão utilizadas técnicas de aprendizado de máquina supervisionadas de regressão para prever o fluxo da via. Quanto a essas técnicas, é possível dividi-las novamente em paramétricas e não paramétricas.
