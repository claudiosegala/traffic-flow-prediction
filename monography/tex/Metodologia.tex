...
%Para a escolha dos modelos, foram selecionadas arquiteturas que apresentassem viéses indutivos diferentes. Ou seja, que realizam suas predições a partir de abordagens algoritmicas distintas. O e aprendizagem supervisionada. Já o \acrshort{RF}, por exemplo, faz uso do ..... para calcular suas predições. Utilizar de modelos com conceitos diferentes garante que os resultados dos experimentos não estejam todos enviesados da mesma forma e tendenciosos a apenas uma abordagem.

%Para representar os modelos tradicionais foram escolhidos modelos com viés de aprendizado diferente. Com o \textit{\acrshort{RF}} se tem um representante dos algoritmos que utilizam árvores de decisão para realizar suas predições. Esta abordagem é completamente diferente da abordagem dos algoritmos de aprendizagem profunda, que utilizam do conceito de tentativa e erro e aprendizagem supervisionada. Essa variedade garante que os modelos não estejam todos enviesados da mesma forma.
