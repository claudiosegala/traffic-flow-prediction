...
% TODO: modificar a imagem
%     - botar quatro modelos
%     - colocar o nome dos modelos
%     - mudar a cor da box de fluxo de veículos
%     - mudar a cor da box da Comparação
...
\subsection{Fluxo Semanal}

Na Figura \ref{figure:flow_discution} é mostrado o resultado da agregação dos registros de veículos em um intervalo de 7.5 minutos. É possível ver um certo padrão que indica o comportamento de 1 dia. Além disso, é possível perceber que um dos picos é menor que a média, este é o domingo.
