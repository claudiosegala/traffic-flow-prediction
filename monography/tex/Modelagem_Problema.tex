...
Visto que as limitações dos dados utilizados nesse trabalho e que é inviável utilizar quantidades exorbitantes de fluxo em um modelo para que este possa predizer o fluxo no futuro. É um desafio para o modelo extrair padrões de uma quantidade limitada de fluxo com o fim de prever. Sendo assim, nosso problema é encontrar o modelo mais adequado para a tarefa de predição no cenário de cruzamentos. 