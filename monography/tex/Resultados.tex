...
%TODO: adicionar ref para imagem das predicoes sem tuning
 ...
 Os valores de parâmetros utilizados para a realização deste teste foram os valores mais recorrentes encontrados nos experimentos da seção acima (\textit{Resultado das Escolhas de Parâmetros})
...
\begin{itemize}
    ...
    \item Lambda: 4 valores espaçados, do espaço logarítmico de -2 a 2, e o padrão da biblioteca.
\end{itemize}

\textbf{\acshort{LSTM} e \acrshort{GRU}}:
\begin{itemize}
    \item Taxa de Aprendizado: 0.001, 0.004, 0.016 e 0.064;
