% TODO: retirar a palavras 'significativa', pois parece que só pode usar ela se tivermos feito teste estatístico

% TODO?: Explain better why we choose the models (A gente selecionou uma quantidade de algoritmos que tem vies diferente, RF particiona como arvore (corta o espaço), SVM particiona o espaço (carta o espaço de forma linear) e é iterativo. LSTM é iterativo (Bias tried and error approach no free lunch))
