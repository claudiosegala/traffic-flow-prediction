...
Tendo em mente as informações citadas anteriormente, este trabalho tem como hipótese que o emprego das técnicas de aprendizagem de máquina conseguirão prever o fluxo de veículos em um cruzamento em curto prazo (no máximo uma hora no futuro).
...
\section{Escopo}
%TODO: verificar os meses e o ano dos dados
