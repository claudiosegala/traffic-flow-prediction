...
Mas se não há como prever o futuro, como planejar-se melhor? Uma das soluções promissoras é empregar o uso técnicas de inteligência computacional para aprender como uma via tende a se comportar, tornando possível estimar como o seu fluxo de veículos estará em alguns minutos.
