...
\title{#1}
%\subtitle{}
\author[Claudio S. R. Silva Filho & Pedro Henrique S. Gonzaga]{
	{ \large 
		Claudio S. R. Silva Filho & Pedro Henrique S. Gonzaga\\ \  \\ 
		\small{Orientadores: Prof. Li Weigang e Prof. Geraldo Pereira}\texttt{}
	} \\
	\vspace*{0.2cm}
	\vspace*{0.2cm}}
	% \date{\today}
